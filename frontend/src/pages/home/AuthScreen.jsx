  ...
  return (
    <div className='hero-bg relative'>
        ...
        <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Unlinmited movies, TV shows, and more</h1>
            ...
            <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
                <input 
                    ...
                    value={email}
                    />
                <button className=" whitespace-nowrap bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2  rounded flex justify-center items-center">
                    Get started
            ...
            <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <p className='text-lg md:text-xl'>
                        Watch on Smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blue-ray, and more.
                    </p>
                </div>
        ...
        <div className="py-10 bg-black text-white">
            <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
                {/* left */}
                <div className="flex-1 relative">
                    <img src="/kids.png" alt="Endjoy on your TV" className='mt-4' />
                </div>
                {/* right */}
                <div className="flex-1 text-center md:text-left">
